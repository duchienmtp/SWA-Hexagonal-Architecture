...
public class Money {
    ...
    public Money(BigDecimal amount) {
        if (amount == null) {
            ...
            throw new RestaurantDomainException("Money amount cannot be null or negative.");
        } else {
            this.amount = amount;
        }
    }
    ...
    public Money subtract(Money money) {
        ...
        if (result.compareTo(BigDecimal.ZERO) < 0) {
            throw new RestaurantDomainException("Resulting money amount cannot be negative.");
        }
